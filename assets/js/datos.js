var textos = [{portada:"El Principito",
  ...
  //   var pregunta.innerHTML = texto.quiz.question;
  // }
  // function crearAlternativas(texto,id,i){
  //   var div = document.createElement('div');
  //   var input = document.createElement('input');
  //   input.setAttribute('name','p'+id);
  //   input.innerHTML = texto.quiz.question.alternatives[i];
  // }
  // function cargarPortada(){
  //   agregarImagen(texto[0].portada);
  //   crearPregunta(texto[0].);
  // }
  //
